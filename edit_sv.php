...
if (!empty($_POST)) {
    ...
    if ($s_id != '' ) {
        //update
        $sql = "update user set  Password = '$Password', Email = '$Email', Lever = '$Lever', Phone = '$Phone'  where id = " .$s_id;
    } else {
        //insert
        ...
        <div class="panel-body">
            <form method="post">
                <div class="form-group">
                    ...
                    <input  required="true" disabled  type="text" class="form-control"  name="UserName" value="<?=$UserName?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label >Name:</label>
                    <input   type="text" disabled class="form-control"  name="Name" value="<?=$Name?>">
                </div>
